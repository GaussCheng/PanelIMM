...
function yInit(){
    return  [
                new IOItem("Y00", qsTr("Y00")),
                new IOItem("Y01", qsTr("Y01")),
                new IOItem("Y02", qsTr("Y02")),
                new IOItem("Y03", qsTr("Y03")),
                new IOItem("Y04", qsTr("Y04")),
                new IOItem("Y05", qsTr("Y05")),
                new IOItem("Y06", qsTr("Y06")),
                new IOItem("Y07", qsTr("Y07")),
                new IOItem("Y10", qsTr("Y10")),
                new IOItem("Y11", qsTr("Y11")),
                new IOItem("Y12", qsTr("Y12")),
                new IOItem("Y13", qsTr("Y13")),
                new IOItem("Y14", qsTr("Y14")),
                new IOItem("Y15", qsTr("Y15")),
                new IOItem("Y16", qsTr("Y16")),
                new IOItem("Y17", qsTr("Y17")),
                new IOItem("Y20", qsTr("Y20")),
                new IOItem("Y21", qsTr("Y21")),
                new IOItem("Y22", qsTr("Y22")),
                new IOItem("Y23", qsTr("Y23")),
                new IOItem("Y24", qsTr("Y24")),
                new IOItem("Y25", qsTr("Y25")),
                new IOItem("Y26", qsTr("Y26")),
                new IOItem("Y27", qsTr("Y27")),
                new IOItem("Y30", qsTr("Y30")),
                new IOItem("Y31", qsTr("Y31")),
                new IOItem("Y32", qsTr("Y32")),
                new IOItem("Y33", qsTr("Y33")),
                new IOItem("Y34", qsTr("Y34")),
                new IOItem("Y35", qsTr("Y35")),
                new IOItem("Y36", qsTr("Y36")),
                new IOItem("Y37", qsTr("Y37")),
                new IOItem("Y40", qsTr("Y40")),
                new IOItem("Y41", qsTr("Y41")),
                new IOItem("Y42", qsTr("Y42")),
                new IOItem("Y43", qsTr("Y43")),
                new IOItem("Y44", qsTr("Y44")),
                new IOItem("Y45", qsTr("Y45")),
                new IOItem("Y46", qsTr("Y46")),
                new IOItem("Y47", qsTr("Y47")),
...
function xInit(){
    return [
                new IOItem("X00", qsTr("X00")),
                new IOItem("X01", qsTr("X01")),
                new IOItem("X02", qsTr("X02")),
                new IOItem("X03", qsTr("X03")),
                new IOItem("X04", qsTr("X04")),
                new IOItem("X05", qsTr("X05")),
                new IOItem("X06", qsTr("X06")),
                new IOItem("X07", qsTr("X07")),
                new IOItem("X10", qsTr("X10")),
                new IOItem("X11", qsTr("X11")),
                new IOItem("X12", qsTr("X12")),
                new IOItem("X13", qsTr("X13")),
                new IOItem("X14", qsTr("X14")),
                new IOItem("X15", qsTr("X15")),
                new IOItem("X16", qsTr("X16")),
                new IOItem("X17", qsTr("X17")),
                new IOItem("X20", qsTr("X20")),
                new IOItem("X21", qsTr("X21")),
                new IOItem("X22", qsTr("X22")),
                new IOItem("X23", qsTr("X23")),
                new IOItem("X24", qsTr("X24")),
                new IOItem("X25", qsTr("X25")),
                new IOItem("X26", qsTr("X26")),
                new IOItem("X27", qsTr("X27")),
                new IOItem("X30", qsTr("X30")),
                new IOItem("X31", qsTr("X31")),
                new IOItem("X32", qsTr("X32")),
                new IOItem("X33", qsTr("X33")),
                new IOItem("X34", qsTr("X34")),
                new IOItem("X35", qsTr("X35")),
                new IOItem("X36", qsTr("X36")),
                new IOItem("X37", qsTr("X37")),
                new IOItem("X40", qsTr("X40")),
                new IOItem("X41", qsTr("X41")),
                new IOItem("X42", qsTr("X42")),
                new IOItem("X43", qsTr("X43")),
                new IOItem("X44", qsTr("X44")),
                new IOItem("X45", qsTr("X45")),
                new IOItem("X46", qsTr("X46")),
                new IOItem("X47", qsTr("X47")),
...
var valveDefines = {
    ...
    "valve8"   : new ValveItem(8,   qsTr("Normal Y020"), IO_TYPE_HOLD_DOUBLE_Y, 3, IO_BOARD_0, 8, IO_BOARD_0, 0, 1, IO_BOARD_0, 9, IO_BOARD_0, 1, 1, 1),
//    "valve9"   : new ValveItem(9,   qsTr("Normal Y021"), IO_TYPE_NORMAL_Y, 1, IO_BOARD_0, 9),
    "valve10"  : new ValveItem(10,  qsTr("Normal Y022"), IO_TYPE_HOLD_DOUBLE_Y, 3, IO_BOARD_0, 10, IO_BOARD_0, 27, 1, IO_BOARD_0, 12, IO_BOARD_0, 2, 1, 1),
    "valve11"  : new ValveItem(11,  qsTr("Normal Y023"), IO_TYPE_SINGLE_Y, 3, IO_BOARD_0, 11, IO_BOARD_0, 3, 1),
    ...
    "valve19"  : new ValveItem(19,  qsTr("Normal Y033"), IO_TYPE_HOLD_DOUBLE_Y, 3, IO_BOARD_0, 19, IO_BOARD_0, 31, 1, IO_BOARD_0, 20, IO_BOARD_0, 28, 1, 1),
