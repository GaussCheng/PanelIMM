...
Rectangle {
    ...
    ICStackContainer{
        ...
        function generatePageBaseDefines(defs,type){
            ...
            var ret = [];
            var ioBoardCount = panelController.getConfigValue("s_rw_22_2_0_184");
            if(ioBoardCount == 0)
                ioBoardCount = 1;
    ...
    Timer{
        ...
        onTriggered: {
            var xStatus = panelController.iStatus(0).toString(2).split("").reverse().join("");
            var yStatus = panelController.oStatus(0).toString(2).split("").reverse().join("");
            var i;
            ...
            yStatus = panelController.oStatus(4).toString(2).split("").reverse().join("");
